...
package com.github.kale.parser
...
case class KaleParser(delegate: ParserInterface) extends ParserInterface {

  /**
   * 1. .g4 生成的 BaseParser 类，传入 sqlText 生成 parser
   * 2. Kale Visitor 继承 .g4 生成的 Visitor 类
   * 3. 调用第二步生成类的 visitSingleStatement 方法，传入 parser.singleStatement
   */
